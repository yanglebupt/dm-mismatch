...
def parse_args_and_config():
    ...
    parser.add_argument('--sample_cs_image', action='store_true', help='Whether to produce cs image samples from the model')
    ...
    parser.add_argument('--dataset',type=str,default="",help="dataset name for test")
    ...
    if not args.test and not args.sample and not args.sample_cs_image and not args.fast_fid:
        ...
        if args.sample or args.sample_cs_image:
...
def main():
    ...
    try:
        ...
        if args.test:
            ...
            runner.sample()
        elif args.sample_cs_image:
            runner.sample_cs_image()
        elif args.fast_fid:
            runner.fast_fid()
        else:
            runner.train()
